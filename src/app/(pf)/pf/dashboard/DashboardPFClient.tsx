          ...
          <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' as const }}>
                <a href="/pf/receitas" style={{ fontSize: 13, fontWeight: 600, color: '#fff', background: INDIGO, padding: '7px 16px', borderRadius: 8, textDecoration: 'none' }}>
                  + Lançar receitas →
                </a>
                <a href="/pf/despesas" style={{ fontSize: 13, fontWeight: 600, color: '#818CF8', background: 'rgba(79,70,229,0.1)', padding: '7px 16px', borderRadius: 8, textDecoration: 'none' }}>
                  + Lançar despesas →
                </a>
              </div>
            </div>
